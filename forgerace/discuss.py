...
- **Запрещено**: конкретные антипаттерны для этой задачи (из дискуссии). Если нет — "—"
- **Проверка**: команда верификации. Должна быть конкретной и запускаемой. Если неизвестна — "make check"
- **Критерий готовности**: бизнес-результат (что должно работать)
- **Дискуссия**: {topic}
- **Агент**: —
- **Ветка**: —
