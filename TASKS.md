...
### TASK-120: Реализация функции детекции тупиков
- **Статус**: open
- **Приоритет**: P1
- **Этап**: 1
- **Зависимости**: —
...
### TASK-121: Интеграция детекции тупиков в пайплайн
- **Статус**: open
- **Приоритет**: P1
- **Этап**: 2
- **Зависимости**: TASK-117
...
### TASK-122: Тестирование детекции тупиков
- **Статус**: open
- **Приоритет**: P1
- **Этап**: 3
...
### TASK-123: Реализация парсера append-only лога в TASKS.md
- **Статус**: open
- **Приоритет**: P2
- **Этап**: 2
- **Зависимости**: —
...
### TASK-124: Рефакторинг записи истории попыток (Append-Only)
- **Статус**: open
- **Приоритет**: P2
- **Этап**: 2
- **Зависимости**: TASK-117
...
### TASK-125: Динамический расчет `rework_count` и удаление поля
- **Статус**: open
- **Приоритет**: P2
- **Этап**: 2
- **Зависимости**: TASK-117
